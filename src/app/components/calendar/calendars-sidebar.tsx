...
const SidebarCalendars: React.FC = () => {
  ...
  useEffect(() => {
    const nextButtonSpan = document.querySelector(
      " .react-datepicker__navigation-icon--next"
    );
    const prevButtonSpan = document.querySelector(
  ...
  return (
    <Box
      ...
      sx={{
        ...
        height: isMobile ? "calc(100vh - 86px)" : "100%",
        zIndex: 51,
        bottom: 0,
        left: 0,
    ...
    >
      <DatePicker
        selected={isMobile ? new Date() : date}
