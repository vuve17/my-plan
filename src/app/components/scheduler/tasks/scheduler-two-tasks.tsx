...
import { convertSingleTaskToTaskString, convertSingleTaskStringToTask } from "@/app/lib/user-tasks-functions";
import type { UnknownAction } from "@reduxjs/toolkit";
import { getTaskById } from "@/app/lib/user-tasks-functions";
...
const UserDoubleTask: React.FC<taskProps> = ({
  task1,
  task2,
  openUpdateTaskModal,
}) => {
  ...
  const test =
    new Date(task2.startDate).getHours() - new Date(task1.startDate).getHours();
  ...
  function descriptionAndHeightLength(
    task: Task,
